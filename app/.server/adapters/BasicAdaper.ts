...
/** Common base fields shared across all OIDC payloads */
...
/** AccessToken, RefreshToken, AuthorizationCode, etc. */
export interface TokenPayload extends CommonFields {
    kind:
    | "AccessToken"
    | "AuthorizationCode"
    | "RefreshToken"
...
/** Grant model */
export interface GrantPayload extends CommonFields {
    kind: "Grant";
    openid?: {
        scope?: string;
        claims?: string[];
...
/** Session model */
export interface SessionPayload extends CommonFields {
    kind: "Session";
    uid?: string;
...
/** Interaction model */
export interface InteractionPayload extends CommonFields {
    kind: "Interaction";
    returnTo?: string;
    deviceCode?: string;
    parJti?: string;
    params?: Record<string, any>;
    lastSubmission?: Record<string, any>;
    trusted?: string[];
...
export interface ReplayDetectionPayload extends CommonFields {
    kind: "ReplayDetection";
}

/** Dynamic Client model */
export interface ClientPayload extends CommonFields {
    kind: "Client";
    [key: string]: any; // allow dynamic client properties
}

/** Union of all OIDC payload types */
export type OidcPayload =
    | TokenPayload
    | GrantPayload
    | SessionPayload
    | InteractionPayload
    | ReplayDetectionPayload
    | ClientPayload;
...
abstract class BasicAdapter {
     ...
     *
     */
    async upsert(id: string, payload: OidcPayload, expiresIn: number): Promise<any> {
